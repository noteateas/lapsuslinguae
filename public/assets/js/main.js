...
/************************************************************************************************ **/
  ...
  function nextPrevious(currentSurveyIndex){
    ...
    /** Progress bar **/
        ...
        let circular_progress = document.querySelectorAll('.circular-progress')
    for(let i = 0; i<circular_progress.length; i++){
        ...
        let progress = setInterval(() => {
            progressValue++;
            circular_progress[i].style.background = `conic-gradient(
                        #22b571 ${progressValue * 3.6}deg,
    ...
    /** Edit Profile & Change profile forms **/
    /*document.querySelector("#show-edit-profile-container").addEventListener('click',function (){
    ...
    document.querySelector("#show-change-password-container").addEventListener('click',function (){
    ...
    /** Animation for click on edit goal **/
    $(document).on('click', '#edit-goal-form label', function(){
        $('#edit-goal-form label').css('background','none');
